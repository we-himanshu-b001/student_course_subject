...
class BackendController extends Controller
{
    ...
    public function index(Request $request)
    {
         ...
         */
        /*
        $permission_slug = 'has-access-subject';
        ...
        */
        ...
        return view('subject::backend.pages.app');
    ...
    public function getAssets(Request $request)
    {
        ...
        */
        ...
        $data['module'] = [
            ...
            'version' => config('settings.global.subject_version')??config('subject.version'),
            'is_dev' => config('subject.is_dev'),
        ];
